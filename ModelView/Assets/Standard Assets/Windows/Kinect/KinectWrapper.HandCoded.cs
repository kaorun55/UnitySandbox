...
namespace Windows.Kinect
{
    ...
    public sealed partial class DepthFrame
    {
        ...
        public void CopyFrameDataToIntPtr(RootSystem.IntPtr frameData, uint size)
        {
            ...
            Windows_Kinect_DepthFrame_CopyFrameDataToIntPtr(_pNative, frameData, size);
        }
    }
    ...
    public sealed partial class InfraredFrame
    {
        ...
        public void CopyFrameDataToIntPtr(RootSystem.IntPtr frameData, uint size)
        {
            ...
            Windows_Kinect_InfraredFrame_CopyFrameDataToIntPtr(_pNative, frameData, size);
        }
    }
    ...
    public sealed partial class LongExposureInfraredFrame
    {
        ...
        public void CopyFrameDataToIntPtr(RootSystem.IntPtr frameData, uint size)
        {
            ...
            Windows_Kinect_LongExposureInfraredFrame_CopyFrameDataToIntPtr(_pNative, frameData, size);
        }
    }
    ...
    public sealed partial class CoordinateMapper
    {
        ...
        public void MapColorFrameToDepthSpaceUsingIntPtr(RootSystem.IntPtr depthFrameData, int depthFrameSize, Windows.Kinect.DepthSpacePoint[] depthSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
        ...
        public void MapColorFrameToCameraSpaceUsingIntPtr(RootSystem.IntPtr depthFrameData, int depthFrameSize, Windows.Kinect.CameraSpacePoint[] cameraSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthFrameToColorSpaceUsingIntPtr(RootSystem.IntPtr depthFrameData, int depthFrameSize, Windows.Kinect.ColorSpacePoint[] colorSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
        ...
        public void MapDepthFrameToCameraSpaceUsingIntPtr(RootSystem.IntPtr depthFrameData, int depthFrameSize, Windows.Kinect.CameraSpacePoint[] cameraSpacePoints)
        {
            if (_pNative == RootSystem.IntPtr.Zero)
            {
                throw new RootSystem.ObjectDisposedException("CoordinateMapper");
            ...
            uint length = (uint)depthFrameSize / sizeof(UInt16);
            Windows_Kinect_CoordinateMapper_MapDepthFrameToCameraSpace(_pNative, depthFrameData, length, cameraSpacePoints, cameraSpacePoints.Length);
        }
    }
}
